  ...
  return (
    <div className="border rounded-md shadow-sm h-full flex flex-col bg-white dark:bg-gray-900">
      ...
      >
        ...
        {currentTab === 'hardware' && (
          <TabsContent value="hardware" className="flex-grow p-4 overflow-auto m-0 h-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${
                            memoryUsage / memoryTotal > 0.8
                              ? 'bg-red-500'
                              : memoryUsage / memoryTotal > 0.6
                              ? 'bg-amber-500'
                              : 'bg-green-500'
                          }`}
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${
                            flashUsage / flashTotal > 0.8
                              ? 'bg-red-500'
                              : flashUsage / flashTotal > 0.6
                              ? 'bg-amber-500'
                              : 'bg-green-500'
                          }`}
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <span className="col-span-2">
                        {uploadedBinary
                          ? formatFileSize(uploadedBinary.size)
                ...
                >
                  ...
                  {pin.mode === 'output' ? (
                    ...
                    <div className="flex items-center">
                      ...
                      <div
                        className={`flex-grow h-7 flex items-center ${
                          pin.type === 'digital'
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-sm">
                        ...
                        <span className="col-span-2">{isRunning ? '0' : '—'}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <span className="text-gray-500">Clock Speed:</span>
                      <span className="col-span-2">{isRunning ? '100 kHz' : '—'}</span>
                    </div>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <span className="text-gray-500">Clock Speed:</span>
                      <span className="col-span-2">{isRunning ? '4 MHz' : '—'}</span>
                    </div>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <span className="col-span-2">{isRunning ? baudRate : '—'}</span>
                    </div>
